      ...
      <div className='container__content'>
        <div className='header'>
          ...
          <div className="header__text">
            ...
            <br />
            <h2>Biomedical Engineering </h2><h2>Graduate Student Researcher</h2>
              <br />
              <h2>Artist</h2><h2> and Musician</h2>
            <br />
  ...
  let jobs = [
    {
      ...
      'company': 'Functional Optical Imaging Laboratory | Advisor: Dr. Andrew Dunn',
      'place': 'Austin, TX',
      'from': "08-2021",
      'to': null,
      'description': "This is what I'm doing right now. I'm currently working on a project that will improve our understanding of how new blood vessels form, which could lead to new insights into stroke recovery and other diseases.",
      'slug': 'persp-swe'
    },
    {
      'title': "Board Member",
      ...
      'from': "08-2021",
      'to': null,
      'description': "Here, I help provide leadership to the board of directors of ICC Austin, a non-profit organization of student co-op housing, and I help coordinate the Board's activities as a whole to ensure that high-level governance duties are met.",
      'slug': 'persp-swe'
    },
    {
      ...
      'from': "05-2021",
      'to': "10-2021",
      'description': "During my first year rotations, I worked on the development of a decision support system for breast cancer patients, the acquisition and analysis of EEG data, and the fabrication of dry electrodes for long recordings.",
      'slug': 'persp-swe'
    },
    {
    ...
    },*/
    {
      ...
      'from': "05-2019",
      'to': "08-2019",
      'description': "In a hospital, I worked in a small lab to create data visualizations of patient data for clinical and dietary analysis and decision making, managed HIPAA compliance, safety, and ethics for patient research, and shadowed the doctor-patient relationship and epilepsy treatment.",
      'slug': 'persp-swe'
    },
    {
      ...
      'from': "05-2018",
      'to': "08-2018",
      'description': "This was my first exposure to biomedical engineering research, and it was the catalyst for me to pursue a Ph.D. I was working on an interferometer to measure phase delay here. I also wrote automated calibration software for optical equipment in a language I didn't even understand at the time!",
      'slug': 'persp-swe'
    },
    {
      ...
      'from': "08-2017",
      'to': "10-2018",
      'description': "I worked to represent and raise awareness of this brand through a series of coordinated events, averaging 300+ student interactions. It assisted me in becoming more comfortable with planning student events and networking.",
      'slug': 'persp-swe'
    },
    {
      ...
      'from': "01-2018",
      'to': "05-2018",
      'description': "I coordinated student trainings to use a fabrication laboratory, taught computer-aided design and simulation procedures, and directed the development process to build working prototypes.",
      'slug': 'persp-swe'
    },/*
    {
    ...
    },*/
    {
      ...
      'from': "10-2018",
      'to': "08-2019",
      'description': "I got a firsthand look at what it's like to work at a renowned music studio that has worked with artists such as Khalid, Kali Uchis, and French Kiwi Juice. I assisted with the recording process and learned about how songs are mixed and mastered in the music industry.",
      'slug': 'persp-swe'
    },
    {
      ...
      'from': "05-2017",
      'to': "08-2017",
      'description': "I designed and formatted a personal financial statement for customer use, practiced daily responsibilities from tellers to the CFO, and most importantly, I learned good money management.",
      'slug': 'persp-swe'
    },
  ];
