...
function BackToTheTop() {
    return <li className = 'back-to-the-top hidden'
    id = 'back-to-the-top' > < a href = '#header' / > < /li>
}
...
function NavBar({ items }) {
    ...
    return ( < ul className = "navbar" > { links } <
        BackToTheTop / >
        <
        /ul>)
    }
    ...
    function Header() {
        ...
        return ( <
                ...
                <
                h1 > Inês < /h1><h1> Almeida</h
                1 >
                <
                br / >
                <
                h2 > Software Engineer < /h2><h2> | </h
                2 > < h2 > Biomedical Engineer MSc < /h2> <
                br / >
                <
                ...
                function About() {
                    return ( <
                        ...
                        /p> <
                        p >
                        I 'm also a full-stack <b>Software Engineer</b> with a Master'
                        s in < b > Biomedical Engineering < /b>. <
                        /p> <
                        p >
                        I 've lived in 6 different countries in Europe; I'
                        ve published two neuroscience papers; I was president of a non - profit organization
                        for 2 years
                        while in university; and I built a commercial VR video game with my partner from scratch. <
                        /p> <
                        p >
                ...
                function ProjectCard({ title, content, slug, link, keyword, date }) {
                    ...
                    return ( <
                        ...
                        div className = "projects__card__label"
                        style = {
                            { backgroundColor: tag_color[keyword] } } > { keyword } < /div> <
                        /div> <
                        h3 > { title } < /h3> <
                        p style = {
                            { fontStyle: "italic", color: "LightSteelBlue" } } > { date } < /p> <
                        p > { content } < /p> <
                        /a >
                    )
                }
                ...
                function Projects() {
                    ...
                    let project_cards = projects.sort((a, b) => (a.date > b.date) ? -1 : 1).map((props) => < ProjectCard key = { props.slug } {...props }
                        ...
                        return ( <
                            ...
                            <
                            div className = 'projects__cards_container' > { project_cards } <
                            /div> <
                            /div> <
                            /div> <
                            /div>
                    ...
                    function TimelineBar({ first_year, job_bars, bar_height, bar_start }) {
                        ...
                        let sub_bars = job_bars.map((bar) => {
                            return <div className = "work__timeline__subbar"
                            style = {
                                { height: bar[0] + "%", bottom: bar[1] + "%" } }
                            />
                        });
                        ...
                        return ( <
                            ...
                            p className = "work__timeline__start" > { first_year } < /p> { sub_bars } <
                            div className = "work__timeline__bar"
                            style = {
                                { height: bar_height + "%", bottom: bar_start + "%" } }
                            /> <
                            /div>
                        )
                    }
                    ...
                    function Work() {
                        ...
                        return ( <
                            ...
                            div className = 'work' >
                            <
                            TimelineBar first_year = { first_date.format('YYYY') }
                            job_bars = { job_bars }
                            ...
                            div className = "work__items" > {
                                jobs.map((job) => {
                                    return ( <
                                        ...
                                        <
                                        p className = "work__item__place" > < i className = "fa fa-map-marker-alt"
                                        aria - hidden = "true" / > { job.place } < /p> <
                                        h2 > { job.title } < /h2> <
                                        h3 > { job.company } < /h3> <
